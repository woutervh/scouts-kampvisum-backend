...
class ScoutsFunctionService:
    ...
    def create_or_update_scouts_functions_for_user(
        self, user: settings.AUTH_USER_MODEL, abstract_functions: List[AbstractScoutsFunction], abstract_function_descriptions: List[AbstractScoutsFunctionDescription] = None
