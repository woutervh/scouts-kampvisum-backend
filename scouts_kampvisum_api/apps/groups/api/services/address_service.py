...
class AddressService:
    def address_update_or_create(self, group: Group, fields):
        qs = Address.objects.filter(group_admin_uuid=fields.get("group_admin_uuid", ""))
    ...
    def address_create(self, group: Group, fields) -> Address:
        """
        Saves a new Address.
        """
        ...
        instance.group_admin_uuid = fields.get("group_admin_uuid", "")
    ...
    def address_update(self, instance: Address, group: Group, fields) -> Address:
        """
