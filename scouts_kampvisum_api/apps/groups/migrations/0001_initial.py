...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sections', to='scouts_auth.scoutsgroup'),
        ),
        migrations.AddField(
            model_name='scoutssection',
            name='name',
        ...
        migrations.AddConstraint(
            model_name='scoutssection',
            constraint=models.UniqueConstraint(fields=('group', 'name'), name='unique_group_and_name_for_section'),
        ),
        migrations.AddConstraint(
            model_name='scoutsgrouptype',
        ...
        migrations.AddConstraint(
            model_name='defaultscoutssectionname',
            constraint=models.UniqueConstraint(fields=('group_type', 'name'), name='unique_group_type_and_name_for_default_scouts_section_name'),
        ),
    ]
