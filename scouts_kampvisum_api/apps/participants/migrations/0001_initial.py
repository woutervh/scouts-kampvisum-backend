    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_group_admin_id', scouts_auth.groupadmin.models.fields.group_admin_id_field.OptionalGroupAdminIdField(blank=True, default='', max_length=64, null=True)),
                ('group_admin_id', scouts_auth.groupadmin.models.fields.group_admin_id_field.OptionalGroupAdminIdField(blank=True, default='', max_length=64, null=True)),
