    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_group_admin_id', scouts_auth.groupadmin.scouts.group_admin_id_field.GroupAdminIdField(blank=True, default='', max_length=128, null=True)),
                ('group_admin_id', scouts_auth.groupadmin.scouts.group_admin_id_field.GroupAdminIdField(blank=True, default='', max_length=128, null=True)),
