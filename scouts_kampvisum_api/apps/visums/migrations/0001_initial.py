# Generated by Django 3.2.10 on 2022-01-31 22:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', scouts_auth.inuits.models.fields.django_shorthand_model_fields.OptionalTextField(blank=True)),
                ('name', scouts_auth.inuits.models.fields.django_shorthand_model_fields.RequiredCharField(max_length=128)),
                ('camp_types', models.ManyToManyField(to='visums.CampType')),
        ...
        migrations.AddField(
            ...
            name='camp_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category_sets', to='visums.camptype'),
        ),
        migrations.AddField(
            model_name='categoryset',
        ...
        migrations.AddField(
            model_name='category',
            name='camp_types',
            field=models.ManyToManyField(to='visums.CampType'),
        ),
        migrations.AddField(
            model_name='category',
            name='camp_year',
        ...
        migrations.AddField(
            model_name='camptype',
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='visums_camptype_created', to=settings.AUTH_USER_MODEL, verbose_name='Instance created by'),
        ),
        migrations.AddField(
            model_name='camptype',
            name='updated_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='visums_camptype_updated', to=settings.AUTH_USER_MODEL, verbose_name='Instance last update by'),
        ),
