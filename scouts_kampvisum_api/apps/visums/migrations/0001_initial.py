# Generated by Django 3.2.12 on 2022-02-25 10:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='LinkedParticipantAdultCheck',
            fields=[
                ('linkedparticipantcheck_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='visums.linkedparticipantcheck')),
            ],
            options={
                'abstract': False,
            },
            bases=('visums.linkedparticipantcheck',),
        ),
        migrations.CreateModel(
            name='LinkedParticipantCookCheck',
            fields=[
                ('linkedparticipantcheck_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='visums.linkedparticipantcheck')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='LinkedParticipantLeaderCheck',
            fields=[
                ('linkedparticipantcheck_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='visums.linkedparticipantcheck')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='LinkedParticipantMemberCheck',
            fields=[
                ('linkedparticipantcheck_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='visums.linkedparticipantcheck')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='LinkedParticipantResponsibleCheck',
            fields=[
                ('linkedparticipantcheck_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='visums.linkedparticipantcheck')),
            ],
            options={
