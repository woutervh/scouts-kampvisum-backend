    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', scouts_auth.groupadmin.models.fields.group_admin_id_field.GroupAdminIdField(max_length=64)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['parent__index'],
                'permissions': [('read_visum_feedback', "User can view the DC's feedback"), ('update_visum_feedback', 'User is a DC and can edit the feedback'), ('read_visum_approval', 'User can view approval status'), ('update_visum_approval', 'User is a DC and can set approval status')],
            },
        ),
        migrations.AddField(
