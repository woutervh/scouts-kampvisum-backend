...
class CategorySetViewSet(viewsets.GenericViewSet):
    """
    A viewset for viewing and editing CategorySet instances.
    """

    serializer_class = CategorySetSerializer
    queryset = CategorySet.objects.all()

    category_service = CategorySetService()

    @swagger_auto_schema(
        request_body=CategorySetSerializer,
        responses={status.HTTP_201_CREATED: CategorySetSerializer},
    )
    def create(self, request):
        ...
        input_serializer = CategorySetSerializer(
        ...
        output_serializer = CategorySetSerializer(
            instance, context={"request": request}
        )

        return Response(output_serializer.data, status=status.HTTP_201_CREATED)

    @swagger_auto_schema(responses={status.HTTP_200_OK: CategorySetSerializer})
    def retrieve(self, request, pk=None):
        ...
        serializer = CategorySetSerializer(instance, context={"request": request})
    ...
    def partial_update(self, request, pk=None):
        ...
        serializer = CategorySetSerializer(
            data=request.data,
            instance=instance,
    ...
    def delete(self, request, pk):
        ...
        instance = get_object_or_404(CategorySet.objects, pk=pk)
        instance.delete()
    ...
    def list(self, request):
        ...
        if page is not None:
            serializer = CategorySetSerializer(page, many=True)
            return self.get_paginated_response(serializer.data)
        else:
            serializer = CategorySetSerializer(instances, many=True)
            return Response(serializer.data)
    ...
    def sub_categories(self, request, pk=None):
        ...
        output_serializer = CategorySetSerializer(instances, many=True)
