...
class CampYearCategorySetService:
    ...
    def get_category_set_for_curent_year(self) -> CampYearCategorySet:
        return self.get_category_set(None, year=self.camp_year_service.get_or_create_current_camp_year())
