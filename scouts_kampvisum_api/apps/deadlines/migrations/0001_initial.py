    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="deadlines.defaultdeadlineflag",
                    ),
                ),
                (
                    "item_sub_category",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="default_deadline_set",
                to="camps.campyear",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="deadlines_defaultdeadline_created",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="deadlines_defaultdeadline_updated",
                to=settings.AUTH_USER_MODEL,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="deadline_item",
                to="deadlines.defaultdeadlineitem",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="deadlines_deadlineflag_created",
                to=settings.AUTH_USER_MODEL,
                verbose_name="Created by",
            ),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="deadlines_deadlineflag_updated",
                to=settings.AUTH_USER_MODEL,
                verbose_name="updated by",
            ),
        ),
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="due_date",
                to="deadlines.defaultdeadline",
            ),
        ),
        migrations.AddField(
            model_name="deadline",
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="deadlines_deadline_created",
                to=settings.AUTH_USER_MODEL,
                verbose_name="Created by",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="deadline", to="deadlines.DeadlineItem"
            ),
        ),
        migrations.AddField(
            model_name="deadline",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="deadlines_deadline_updated",
                to=settings.AUTH_USER_MODEL,
                verbose_name="updated by",
            ),
        ),
