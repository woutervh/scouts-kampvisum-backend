...
class GroupAdminAddressSerializer(serializers.Serializer):
    ...
    postal_address = serializers.BooleanField(source="postadres", default=False)
...
class GroupAdminGroupSerializer(serializers.Serializer):
    ...
    foundation = serializers.DateTimeField(source="opgericht", default=timezone.now)
    only_leaders = serializers.BooleanField(source="enkelLeiding", default=False)
