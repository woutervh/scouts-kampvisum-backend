# Generated by Django 3.2.10 on 2022-01-26 20:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_admin_id', scouts_auth.groupadmin.scouts.group_admin_id_field.GroupAdminIdField(blank=True, max_length=128)),
                ('first_name', scouts_auth.inuits.models.fields.django_shorthand_model_fields.OptionalCharField(blank=True, max_length=64)),
                ('last_name', scouts_auth.inuits.models.fields.django_shorthand_model_fields.OptionalCharField(blank=True, max_length=128)),
                ('email', scouts_auth.inuits.models.fields.django_shorthand_model_fields.OptionalCharField(blank=True, max_length=128)),
                ('birth_date', scouts_auth.inuits.models.fields.datetype_aware_date_field.DatetypeAwareDateField(blank=True, null=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='people_inuitsmember_created', to=settings.AUTH_USER_MODEL, verbose_name='Instance created by')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='people_inuitsmember_updated', to=settings.AUTH_USER_MODEL, verbose_name='Instance last update by')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_group_admin_id', scouts_auth.groupadmin.scouts.group_admin_id_field.GroupAdminIdField(blank=True, max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_on', models.DateTimeField(default=django.utils.timezone.now)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='people_inuitsparticipant_created', to=settings.AUTH_USER_MODEL, verbose_name='Instance created by')),
                ('member', scouts_auth.inuits.models.fields.django_shorthand_model_fields.OptionalForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='people.inuitsmember')),
                ('non_member', scouts_auth.inuits.models.fields.django_shorthand_model_fields.OptionalForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='people.inuitsnonmember')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='people_inuitsparticipant_updated', to=settings.AUTH_USER_MODEL, verbose_name='Instance last update by')),
            ],
            options={
                'abstract': False,
            },
